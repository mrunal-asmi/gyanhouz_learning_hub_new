...
export default function ProgramsExplorer() {
  ...
  const programs: Program[] = [
    ...
    },
    {
      ...
      ageRange: '6-10 years',
      description:
        'Developing critical thinking and problem-solving through project-based learning',
          ...
          {filteredPrograms.map((program) => (
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div
                  className={`absolute top-4 right-4 px-4 py-2 bg-${program.color} text-white rounded-full font-semibold text-sm shadow-lg`}
                >
                  {program.ageRange}
                </div>
              </div>
