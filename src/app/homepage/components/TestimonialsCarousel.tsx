...
export default function TestimonialsCarousel() {
  ...
  const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    testimonial: 'My son went from being shy and hesitant to confidently presenting his robot project at school. The transformation in just 6 months has been incredible. He now asks "why" and "how" about everything!',
  ...
  },
  {
    ...
    rating: 5,
    testimonial: 'The Career Discovery Lab changed everything. Ananya experienced being a doctor, engineer, and designer. Now she has clear goals instead of confusion. Worth every rupee!',
  ...
  },
  {
    ...
    rating: 5,
    testimonial: 'The preschool program is nothing like traditional schools. Rohan learns through play, experiments, and exploration. His curiosity and problem-solving skills have skyrocketed!',
  ...
  },
  {
    ...
    rating: 5,
    testimonial: 'Ishaan built his first working circuit at GYANHOUZ. Now he wants to be an inventor. The hands-on approach makes learning exciting, not boring. Best decision we made!',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center space-x-2 mt-8">
          ...
          <button
            ...
            currentIndex === index ?
            'bg-primary w-8' : 'bg-muted hover:bg-muted-foreground/30'}`}
