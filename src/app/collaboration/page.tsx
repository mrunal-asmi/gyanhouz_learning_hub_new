        ...
        <section className="py-20 bg-primary/5">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-source">
              Join our ecosystem of innovators, educators, and industry leaders to create meaningful
              impact in learning.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6 font-source">
                  At GYANHOUZ, we believe in the power of collective intelligence. By partnering
                  with us, you become part of a movement that is redefining how children learn and
                  grow.
                </p>
              ...
              <div className="bg-card p-8 rounded-2xl shadow-elevated border border-border">
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      className="w-full px-4 py-2 rounded-lg border border-border bg-background focus:ring-2 focus:ring-primary outline-none transition-all h-32"
