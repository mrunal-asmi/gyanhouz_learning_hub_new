        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-white/70 mb-6 leading-relaxed">
              India's first integrated learning ecosystem transforming education through experiential learning, innovation labs, and career discovery programs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks?.programs?.map((link) => (
                <li key={link?.href}>
                  <Link href={link?.href} className="text-white/70 hover:text-white transition-smooth">
                    {link?.label}
                  </Link>
                </li>
              ))}
