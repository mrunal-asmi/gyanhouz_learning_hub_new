      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {contactMethods.map((method, index) => (
            ...
            >
              <div
                className={`w-16 h-16 bg-gradient-to-br ${method.color} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-smooth`}
              >
        ...
        <div className="mt-12 bg-gradient-to-br from-primary to-secondary rounded-2xl p-8 lg:p-12 text-white">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl lg:text-3xl font-bold mb-4">Need Immediate Assistance?</h3>
              <p className="text-white/90 mb-6">
                Our admissions counselors are available Monday to Saturday, 9:00 AM to 6:00 PM. For
                urgent inquiries outside business hours, leave us a message and we'll get back to
