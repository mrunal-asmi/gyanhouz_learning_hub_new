...
const mockCampuses: Campus[] = [
  {
    ...
    programs: ['Preschool', 'School of Creativity', 'Science Labs', 'Industry Club'],
  ...
  },
  {
    ...
    programs: ['Preschool', 'Science Labs', 'Career Discovery'],
  ...
  },
  {
    ...
    programs: ['Preschool', 'School of Creativity', 'Science Labs'],
  ...
  },
  {
    ...
    programs: ['Preschool', 'Science Labs', 'Industry Club'],
  ...
  },
  {
    ...
    lat: 12.9396,
    lng: 80.2304,
    facilities: ['Science Lab', 'Career Discovery Center', 'Digital Library', 'Activity Hall'],
    programs: ['Preschool', 'Science Labs', 'Industry Club'],
    timing: 'Mon-Sat: 8:30 AM - 6:30 PM',
    admissionStatus: 'Open',
  },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Visit any of our 12+ campuses across India to experience the future of education
            firsthand
          </p>
        </div>
            ...
            {filteredCampuses.map((campus) => (
              ...
              >
                <div className="relative h-48">
                  ...
                  <div
                    className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-bold ${getStatusColor(campus.admissionStatus)}`}
                  >
                    {campus.admissionStatus === 'Open'
                      ? '✓ Admissions Open'
                      : campus.admissionStatus === 'Limited'
                        ? '⚠ Limited Seats'
                        : '⏳ Waitlist Only'}
                  </div>
                </div>
                  ...
                  <div className="pt-4 border-t border-border">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedCampus.programs.map((program, idx) => (
                        <span
                          key={idx}
                          className="px-4 py-2 bg-primary/10 text-primary text-sm font-medium rounded-lg"
                        >
                          {program}
                        </span>
                      ))}
