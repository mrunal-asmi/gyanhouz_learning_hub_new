...
const ResearchSection = ({ className = '' }: ResearchSectionProps) => {
  ...
  return (
    <section className={`py-16 lg:py-24 bg-gradient-to-br from-brand-blue/5 to-background ${className}`}>
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Our methodologies are grounded in rigorous academic research and validated by leading educational institutions
          </p>
        </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Every aspect of our curriculum is designed based on peer-reviewed research in child psychology, cognitive development, and educational neuroscience. Our methods have been validated through longitudinal studies tracking child development outcomes over 5+ years.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start space-x-2">
                  <Icon name="CheckCircleIcon" size={20} className="text-brand-orange mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Scientifically validated teaching methodologies</span>
                </li>
                <li className="flex items-start space-x-2">
                  <Icon name="CheckCircleIcon" size={20} className="text-brand-orange mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Continuous assessment and improvement protocols</span>
                </li>
                <li className="flex items-start space-x-2">
                  <Icon name="CheckCircleIcon" size={20} className="text-brand-orange mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">Regular publication of findings in academic journals</span>
                </li>
              </ul>
            </div>
          </div>
