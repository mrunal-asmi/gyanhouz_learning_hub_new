...
const FounderSection = ({ className = '' }: FounderSectionProps) => {
  ...
  return (
    <section className={`py-16 lg:py-24 bg-gradient-to-br from-muted/50 to-background ${className}`}>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div key={index} className="flex items-start space-x-3">
                  <Icon name="CheckCircleIcon" size={20} className="text-brand-orange mt-1 flex-shrink-0" />
