...
export default function CareerOutcomesSection({ onEnrollClick }: CareerOutcomesSectionProps) {
  ...
  { metric: '95% Career Clarity', description: 'Students identify 2-3 career paths they\'re passionate about', icon: 'LightBulbIcon' },
  { metric: '87% Skill Improvement', description: 'Measurable growth in technical and soft skills', icon: 'ChartBarIcon' },
  { metric: '92% Parent Satisfaction', description: 'Parents see visible confidence and direction in their children', icon: 'HeartIcon' },
  { metric: '100% Industry Exposure', description: 'Every student connects with real professionals', icon: 'UserGroupIcon' }];
  ...
  const successStories: SuccessStory[] = [
  {
    ...
    quote: 'I always thought I wanted to be a doctor because everyone said so. After trying the engineering zone, I realized I love building robots!',
  ...
  },
  {
    ...
    quote: 'The medical zone showed me that being a doctor isn\'t the only way to help people. I want to be a medical researcher now!',
  ...
  },
  {
    ...
    quote: 'I started a small online business after learning entrepreneurship here. Made ₹15,000 in my first month!',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Our career labs don't just expose children to careers—they create lasting clarity and confidence
          </p>
        </div>
            ...
            <div key={index} className="bg-card rounded-xl overflow-hidden shadow-lg border border-border hover:shadow-xl transition-smooth">
                <div className="relative h-48">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                    <div className="text-white font-bold">{story.childName}, {story.age}</div>
                  </div>
                </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-brand-orange to-brand-red rounded-2xl p-8 lg:p-12 text-center text-white">
          ...
          <p className="text-lg mb-6 max-w-2xl mx-auto">
            While other children struggle with career confusion in 11th-12th grade, your child will already have clarity, skills, and direction
          </p>
