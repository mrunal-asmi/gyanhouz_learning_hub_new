  ...
  const careerZones: CareerZone[] = [
    {
      ...
      icon: 'HeartIcon',
      description:
        'Experience life-saving professions through realistic medical simulations and healthcare scenarios',
      careers: [
        'Doctor',
        'Surgeon',
        'Nurse',
    ...
    },
    {
      ...
      icon: 'CogIcon',
      description:
        'Build, design, and innovate with hands-on engineering projects and tech workshops',
      careers: [
        'Software Engineer',
        'Mechanical Engineer',
        'Robotics Engineer',
    ...
    },
    {
      ...
      icon: 'BriefcaseIcon',
      description:
        'Launch mini-businesses, understand markets, and develop entrepreneurial thinking',
      careers: [
        'Entrepreneur',
        'Marketing Manager',
        'Financial Analyst',
    ...
    },
    {
      ...
      icon: 'CakeIcon',
      description:
        'Master culinary skills and hospitality management in professional kitchen settings',
      careers: [
        'Chef',
        'Pastry Chef',
        'Food Scientist',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Each zone is designed with real industry equipment, professional mentors, and hands-on
            projects that mirror actual workplace scenarios
          </p>
        </div>
          ...
          {careerZones.map((zone) => (
            ...
            >
              <Icon
                name={zone.icon}
                size={32}
                className={`mx-auto mb-2 ${activeZone === zone.id ? `text-${zone.color}` : 'text-muted-foreground'}`}
              />
              <div
                className={`text-sm font-semibold ${activeZone === zone.id ? 'text-foreground' : 'text-muted-foreground'}`}
              >
                {zone.title}
              </div>
            </button>
        ...
        <div className="bg-card rounded-2xl shadow-lg overflow-hidden border border-border">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="relative h-64 lg:h-auto">
              ...
              <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg">
                <div className="flex items-center space-x-2">
                  <Icon
                    name={activeZoneData.icon}
                    size={24}
                    className={`text-${activeZoneData.color}`}
                  />
            ...
            <div className="p-8 lg:p-12 space-y-6">
              ...
              <p className="text-lg text-muted-foreground">{activeZoneData.description}</p>
