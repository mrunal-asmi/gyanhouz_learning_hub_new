...
const industryBenefits = [
  {
    ...
    description: 'Quarterly visits to robotics companies, startups, and Science Labs',
    color: 'brand-blue',
  },
  {
    icon: 'UserGroupIcon',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {industryBenefits?.map((benefit, index) => (
            ...
            >
              <div
                className={`w-16 h-16 rounded-full bg-${benefit?.color}/10 flex items-center justify-center mx-auto mb-4`}
              >
        ...
        <div className="bg-gradient-to-br from-brand-blue/10 to-secondary/10 rounded-2xl p-8 lg:p-12 border border-brand-blue/20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-foreground mb-6">Future Career Pathways</h3>
              <p className="text-lg text-muted-foreground mb-8">
                Skills learned in our Electronics & Robotics Lab directly prepare students for
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Starting salary for robotics engineers in India
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-semibold text-brand-blue uppercase">
                    Industry Growth
                  </span>
                </div>
                <div className="text-3xl font-bold text-foreground mb-2">45% CAGR</div>
                <p className="text-sm text-muted-foreground">
                  Robotics & IoT market growth in India (2024-2030)
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Expected robotics jobs by 2030 in India
                </p>
              </div>
            </div>
          </div>
