...
export default function LabFacilitiesSection() {
  ...
  const labFacilities: LabFacility[] = [
  {
    ...
    icon: 'BoltIcon',
    description: 'Explore mechanics, electricity, magnetism, optics, and modern physics through interactive experiments',
    equipment: ['Digital oscilloscopes', 'Force sensors', 'Motion trackers', 'Laser optics kits', 'Electromagnetic apparatus', 'Wave demonstration tools'],
  ...
  },
  {
    ...
    icon: 'BeakerIcon',
    description: 'Conduct safe chemical reactions and understand molecular structures through hands-on synthesis',
    equipment: ['Fume hoods', 'pH meters', 'Spectrophotometers', 'Distillation apparatus', 'Molecular model kits', 'Safety equipment'],
  ...
  },
  {
    ...
    icon: 'EyeIcon',
    description: 'Study living organisms, cells, genetics, and ecosystems through microscopy and dissection',
    equipment: ['Digital microscopes', 'Specimen collection', 'Dissection kits', 'DNA extraction tools', 'Plant growth chambers', 'Aquatic ecosystems'],
  ...
  },
  {
    ...
    icon: 'GlobeAltIcon',
    description: 'Investigate environmental issues, sustainability, and ecological systems through field studies',
    equipment: ['Water quality testers', 'Soil analysis kits', 'Weather stations', 'Air quality monitors', 'Renewable energy models', 'Composting systems'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Research-grade equipment and professional lab environments that schools simply cannot afford
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          ...
          <button
            ...
            'border-border bg-card hover:border-primary/30'}`
              ...
              <Icon name={lab.icon} size={32} className={`mx-auto mb-2 ${activeLab === lab.id ? `text-${lab.color}` : 'text-muted-foreground'}`} />
              <div className={`text-sm font-semibold ${activeLab === lab.id ? 'text-foreground' : 'text-muted-foreground'}`}>
                {lab.title}
              </div>
            </button>
          )}
            ...
            <div className="relative h-64 lg:h-auto">
              ...
              <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg">
                <div className="flex items-center space-x-2">
                  <Icon name={activeLabData.icon} size={24} className={`text-${activeLabData.color}`} />
            ...
            <div className="p-8 lg:p-12 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <div key={index} className="flex items-center space-x-2">
                      <Icon name="CheckCircleIcon" size={20} className={`text-${activeLabData.color}`} />
              ...
              <div className="pt-4">
                <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-foreground">Student-Equipment Ratio</span>
