    ...
    <section className="py-16 lg:py-24 bg-gradient-to-br from-muted/30 to-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div key={index} className="bg-card rounded-xl overflow-hidden shadow-lg border border-border hover:shadow-xl transition-smooth hover:-translate-y-1">
              {/* Experiment Image */}
              <div className="relative h-48">
                ...
                <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm px-3 py-1 rounded-full">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs font-semibold text-foreground">{experiment.subject}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 space-y-3">
                ...
                <div className="pt-3 border-t border-border">
                  <div className="flex items-start space-x-2">
                    <Icon name="AcademicCapIcon" size={20} className={`text-${experiment.color} mt-0.5 flex-shrink-0`} />
                    <div>
                      <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1">Learning Outcome</div>
                      <p className="text-sm text-foreground font-medium">{experiment.learningOutcome}</p>
                    </div>
                  </div>
                </div>
              </div>
