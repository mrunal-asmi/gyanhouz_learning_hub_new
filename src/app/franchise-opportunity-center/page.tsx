...
export const metadata: Metadata = {
  ...
  description:
    "Join India's fastest-growing education revolution. Partner with GYANHOUZ and own a premium learning ecosystem with proven ROI, comprehensive training, and ongoing support across 45+ cities.",
};
