...
export default function LearningProgramsInteractive() {
  ...
  { id: 'innovation', label: 'Innovation Labs', ageRange: '7-10 years' }];
  ...
  const programs: Program[] = [
  {
    ...
    ageRange: '2-6 years',
    ageGroup: 'preschool',
    description: 'Build strong cognitive foundations through play-based learning, sensory exploration, and hands-on activities that develop critical thinking from an early age.',
  ...
  },
  {
    ...
    ageRange: '6-10 years',
    ageGroup: 'creativity',
    description: 'Unleash creative potential through project-based learning, design thinking workshops, and collaborative problem-solving activities.',
  ...
  },
  {
    ...
    ageRange: '7-10 years',
    ageGroup: 'innovation',
    description: 'Master robotics fundamentals through hands-on building, coding, and programming real robots with sensors and actuators.',
  ...
  },
  {
    ...
    ageRange: '7-10 years',
    ageGroup: 'innovation',
    description: 'Explore electronics through circuit building, component understanding, and creating functional electronic projects.',
  ...
  },
  {
    ...
    ageRange: '6-10 years',
    ageGroup: 'innovation',
    description: 'Conduct real scientific experiments, learn the scientific method, and discover physics, chemistry, and biology through hands-on exploration.',
  ...
  },
  {
    ...
    ageRange: '8-10 years',
    ageGroup: 'creativity',
    description: 'Experience real-world careers through simulation labs, industry visits, and hands-on professional skill development.',
  ...
  },
  {
    ...
    gyanhouz: 'Innovation labs with project workstations'
  },
  {
    feature: 'Assessment',
  ...
  const testimonials: Testimonial[] = [
  {
    ...
    testimonial: 'Aarav has transformed from a shy child to a confident problem-solver. He now asks "why" and "how" about everything! The hands-on learning approach has made him genuinely curious about the world.',
  ...
  },
  {
    ...
    childName: 'Ananya',
    childAge: 8,
    program: 'Robotics Innovation Lab',
    testimonial: 'My daughter built her first robot at age 7! She now understands coding concepts that I learned in college. GYANHOUZ has given her skills that will define her future career.',
  ...
  },
  {
    ...
    testimonial: 'Rohan discovered his passion for architecture through the career simulation labs. He now knows exactly what he wants to become and is already developing relevant skills. This clarity at age 9 is incredible!',
  ...
  const milestones: Milestone[] = [
  {
    ...
    description: 'Building cognitive foundations through sensory exploration, basic motor skills, and early language development.',
    skills: ['Sensory Play', 'Motor Skills', 'Language Basics', 'Social Interaction']
  },
  {
    age: '4-5',
    title: 'Curiosity Expansion',
    description: 'Developing critical thinking through questioning, experimentation, and structured play-based learning.',
    skills: ['Scientific Thinking', 'Math Concepts', 'Creative Expression', 'Problem Solving']
  },
  {
    age: '6-7',
    title: 'Skill Building',
    description: 'Mastering foundational academic skills while introducing hands-on project work and collaborative learning.',
    skills: ['Reading & Writing', 'Computational Thinking', 'Team Projects', 'Design Basics']
  },
  {
    age: '8-9',
    title: 'Innovation & Discovery',
    description: 'Engaging in complex projects, robotics, electronics, and career exploration through simulation labs.',
    skills: ['Robotics', 'Electronics', 'Career Awareness', 'Advanced Projects']
  },
  {
    age: '10+',
    title: 'Mastery & Specialization',
    description: 'Developing expertise in chosen areas, preparing for competitive challenges, and building portfolio projects.',
  ...
  activeTab === 'all' ?
  programs :
  programs.filter((program) => program.ageGroup === activeTab);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center py-16">
              <p className="text-xl text-muted-foreground">
                No programs found for this age group.
              </p>
            </div>
          }
        </div>
